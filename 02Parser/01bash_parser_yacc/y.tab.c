...
{
       0,     0,     3,     4,     7,     9,    12,    16,    21,    23,
      26,    30,    33,    36,    40,    43,    44,    47
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      26,     0,    -1,    -1,    26,    27,    -1,    23,    -1,    28,
      23,    -1,    28,    20,    27,    -1,    28,     3,     6,    23,
      -1,    15,    -1,    15,     6,    -1,    16,    30,     6,    -1,
      16,    30,    -1,    17,     6,    -1,    17,     6,     6,    -1,
      18,    29,    -1,    -1,    30,    30,    -1,    10,     6,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,   116,   116,   118,   122,   123,   125,   126,   132,   133,
     135,   137,   138,   139,   141,   144,   148,   149
};
#endif
...
{
  "$end", "error", "$undefined", "REDIR", "NUMBER", "ALNUM", "WORD",
  "OPT", "FSTDIN", "PLUS", "MINUS", "TIMES", "DIVIDE", "POWER", "OPT_D",
  "CAT", "CUT", "GREP", "SORT", "JOIN", "PIPE", "LEFT_PARENTHESIS",
  "RIGHT_PARENTHESIS", "END", "NEG", "$accept", "Input", "Line", "Command",
  "OptionsSort", "OptionsCut", 0
};
#endif
...
{
       2,     0,     1,     8,     0,     0,    15,     4,     3,     0,
       9,     0,    11,    12,    14,     0,     0,     5,    17,    10,
      16,    13,     0,     6,     7
};
...
{
     -13,     0,   -13,    -5,    -3,     3,   -13,   -13,   -13,    -1,
     -13,     4,     2,     7,   -13,     8,   -12,   -13,   -13,   -13,
      -3,   -13,    -2,   -13,   -13
};
...
{
       2,    10,    15,     3,     4,     5,     6,    11,    19,    13,
      18,     7,    11,    21,    22,     3,     4,     5,     6,    16,
      12,    24,    17,     7,     0,    23
};
...
{
       0,     6,     3,    15,    16,    17,    18,    10,     6,     6,
       6,    23,    10,     6,     6,    15,    16,    17,    18,    20,
       4,    23,    23,    23,    -1,    16
};
...
{
       0,    26,     0,    15,    16,    17,    18,    23,    27,    28,
       6,    10,    30,     6,    29,     3,    20,    23,     6,     6,
      30,     6,     6,    27,    23
};
...
/* Line 1806 of yacc.c  */
#line 126 "calc.y"
    { strcpy(queries[crtq].as,(yyvsp[(3) - (4)].str));
...
#line 133 "calc.y"
    { reset(&queries[crtq]);
					  strcpy(queries[crtq].from,(yyvsp[(2) - (2)].str));}
    break;
...
/* Line 1806 of yacc.c  */
#line 135 "calc.y"
    { strcpy(queries[crtq].from,(yyvsp[(3) - (3)].str));}
    break;
...
/* Line 1806 of yacc.c  */
#line 138 "calc.y"
    { zugrep(&queries[crtq],(yyvsp[(2) - (2)].str)); }
    break;
...
#line 139 "calc.y"
    { strcpy(queries[crtq].from,(yyvsp[(3) - (3)].str));
					zugrep(&queries[crtq],(yyvsp[(2) - (3)].str)); }
    break;
